...
function App() {
  ...
  const claimNFTs = (_amount) => {
    ...
    setFeedback("Minting your Codebeast...");
    setClaimingNft(true);
    blockchain.smartContract.methods
      .mint(blockchain.account, _amount)
      .send({
        gasLimit: "285000",
        to: "0x1FD553ECEF7B97C8b61Fd5D768384b47E19e6216",
      ...
      .then((receipt) => {
        setFeedback(
          "WOW, you now own a Codebeast. go visit Opensea.io to view it."
        );
        setClaimingNft(false);
          ...
          <s.Container flex={1} ai={"center"} jc={"center"}>
            ...
            {Number(data.totalSupply) == 10000 ? (
              <>
                ...
                <s.SpacerSmall />
                <s.TextDescription style={{ textAlign: "center" }}>
                  You can still find Codebeasts on{" "}
                  <a
                    target={"_blank"}
